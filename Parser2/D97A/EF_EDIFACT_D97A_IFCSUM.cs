namespace EdiFabric.Templates.EdifactD97A
{
    ...
    public class Loop_EQD_IFCSUM_2
    {
        ...
        [ListCount(9)]
        [Pos(12)]
        public virtual List<Loop_NAD_IFCSUM_4> NADLoop { get; set; }
        /// <summary>
        /// Loop for ATTACHED EQUIPMENT
        /// </summary>
        [DataMember]
    ...
    public class Loop_GID_IFCSUM
    {
        ...
        [ListCount(999)]
        [Pos(20)]
        public virtual List<Loop_SGP_IFCSUM_2> SGPLoop { get; set; }
        /// <summary>
        /// Loop for TRANSPORT CHARGE/RATE CALCULATIONS
        /// </summary>
        [DataMember]
        [ListCount(99)]
        [Pos(21)]
        public virtual List<Loop_TCC_IFCSUM_4> TCCLoop { get; set; }
        /// <summary>
        /// Loop for DANGEROUS GOODS
        /// </summary>
        [DataMember]
    ...
    [DataContract()]
    [Group(typeof(SGP))]
    public class Loop_SGP_IFCSUM_2
    {
    ...
    [DataContract()]
    [Group(typeof(TCC))]
    public class Loop_TCC_IFCSUM_4
    {
