namespace EdiFabric.Templates.EdifactD97A
{
    ...
    public class Loop_NAD_COPINO
    {
        ...
        [ListCount(9)]
        [Pos(2)]
        public virtual List<Loop_CTA_COPINO> CTALoop { get; set; }
    }
    ...
    public class TSCOPINO : EdiMessage
    {
        ...
        [ListCount(9)]
        [Pos(5)]
        public virtual List<Loop_RFF_COPINO> RFFLoop { get; set; }
        /// <summary>
        /// Loop for DETAILS OF TRANSPORT
        /// </summary>
        [DataMember]
