namespace EdiFabric.Templates.EdifactD97A
{
    ...
    public class Loop_ALC_PRICAT
    {
        ...
        [ListCount(10)]
        [Pos(4)]
        public virtual List<Loop_QTY_PRICAT> QTYLoop { get; set; }
        /// <summary>
        ...
        [ListCount(10)]
        [Pos(5)]
        public virtual List<Loop_PCD_PRICAT> PCDLoop { get; set; }
        /// <summary>
        ...
        [ListCount(10)]
        [Pos(7)]
        public virtual List<Loop_RTE_PRICAT> RTELoop { get; set; }
        /// <summary>
